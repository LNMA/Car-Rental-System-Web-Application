function BDList() {
    var list = "<aside class=\"asideRoot\">\n" +
	    "       <button value=\"editUrlDB\" class=\"ulCar\" onclick=\"editUrlDB()\">Edit Url</button>\n" +
	    "	    <button value=\"editPasswordDB\" class=\"ulCar\" onclick=\"editPasswordDB()\">Edit Password</button>\n" +
	    "	    <button value=\"editUsernameDB\" class=\"ulCar\" onclick=\"editUsernameDB()\">Edit Username</button>\n" +
	    "	    <form action=\"DB.jsp\" method=\"post\">\n" +
	    "       <input type=\"text\" name=\"operation\" value=\"showAllDetail\" readonly hidden />\n" +
	    "       <input type=\"submit\" class=\"ulCar\" value=\"Show Me Detail\" />\n" +
	    "	    </form>\n" +
	    "       </aside>";
    document.getElementById("rootAside").innerHTML = list;
}

function editUsernameDB() {
    var list = "<section class=\"sectionRoot\">\n" +
	    ...
	    "                    Username:\n" +
	    "                </p>\n" +
	    "                <input type=\"text\" name=\"username\" class=\"txtEdit\" placeholder=\"Type new username\" required/>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
...
function editPasswordDB() {
    var list = "<section class=\"sectionRoot\">\n" +
	    ...
	    "                    Password:\n" +
	    "                </p>\n" +
	    "                <input type=\"text\" name=\"password\" class=\"txtEdit\" placeholder=\"Type new Password\" required/>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
...
function editUrlDB() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"DB.jsp\" method=\"post\" >\n" +
	    "                <input type=\"text\" name=\"operation\" value=\"EditUrl\" readonly hidden />\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <p class=\"labelEdit\">\n" +
	    "                    URL:\n" +
	    "                </p>\n" +
	    "                <input type=\"text\" name=\"url\" class=\"txtEdit\" placeholder=\"Type new URL\" required/>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
...
function orderList() {
    var list = "<aside class=\"asideRoot\">\n" +
	    ...
	    "	    </form>\n" +
	    "	    <button value=\"showOrderByUsername\" class=\"ulCar\" onclick=\"showOrderByUsername()\">Shoe Me Oder By Username</button>\n" +
	    "	    <button value=\"showOrderByCarId\" class=\"ulCar\" onclick=\"showOrderByCarId()\">Shoe Me Oder By Car ID</button>\n" +
	    "       </aside>";
    document.getElementById("rootAside").innerHTML = list;
}
...
function accountList() {
    var list = "<aside class=\"asideRoot\">\n" +
	    ...
	    "	    <button value=\"removeAccount\" class=\"ulCar\" onclick=\"removeAcccount()\">Remove Account</button>\n" +
	    ...
	    "	    <button value=\"editType\" class=\"ulCar\" onclick=\"editAccountType()\">Edit Type</button>\n" +
	    ...
	    "	    <button value=\"editSection\" class=\"ulCar\" onclick=\"editAccountSection()\">Edit Section</button>\n" +
	    "	    <button value=\"editRank\" class=\"ulCar\" onclick=\"editAccountRank()\">Edit Rank</button>\n" +
...
function editAccountSection() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"editAccountResult.jsp\" method=\"post\">\n" +
	    "                <input type=\"text\" name=\"operation\" value=\"editSection\" readonly hidden />\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <p class=\"labelEdit\">\n" +
	    ...
	    "                    Section:\n" +
	    "                </p>\n" +
	    "                <input type=\"text\" name=\"section\" class=\"txtEdit\" placeholder=\"Type section\" required/>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
...
function editAccountRank() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"editAccountResult.jsp\" method=\"post\">\n" +
	    "                <input type=\"text\" name=\"operation\" value=\"editRank\" readonly hidden />\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <p class=\"labelEdit\">\n" +
	    ...
	    "                    Rank:\n" +
	    "                </p>\n" +
	    "                <input type=\"text\" name=\"rank\" class=\"txtEdit\" placeholder=\"Type rank\" required/>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
...
function editAccountType() {
    var list = "<section class=\"sectionRoot\">\n" +
	    ...
	    "                    Type:\n" +
	    "                </p>\n" +
	    "                <select class=\"txtEdit\" name=\"type\" required>\n" +
...
function removeAcccount() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"editAccountResult.jsp\" method=\"post\">\n" +
	    "                <input type=\"text\" name=\"operation\" value=\"removeAccount\" readonly hidden />\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <br>\n" +
	    "                <p class=\"labelEdit\">\n" +
...
function selectAccountType() {
    var list = "<section class=\"sectionRoot\">\n" +
	    ...
	    "                <tr>\n" +
	    "                    <td>\n" +
	    "                        <button value=\"root\" class=\"option\" onclick=\"addAccountRoot()\">Root</button>\n" +
	    "                    </td>\n" +
	    "                    <td>\n" +
	    "                        <button value=\"supervisor\" class=\"option\" onclick=\"addAccountSupervisor()\">Supervisor</button>\n" +
	    "                    </td>\n" +
	    "                    <td>\n" +
...
function addAccountSupervisor() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"addAccountResult.jsp\" method=\"post\" name=\"addAccountForm\" onsubmit=\"return validateFormAddSupervisor()\">\n" +
	    "                <table>\n" +
	    "                    <tr>\n" +
	    "                        <td>\n" +
	    "                            <p class=\"label\">\n" +
	    ...
	    "                            <select name=\"type\" class=\"txt\" required contenteditable=\"true\">" +
	    "                                <option value=\"root\">Root</option>\n" +
	    "                                <option value=\"supervisor\" selected=\"true\">Supervisor</option>\n" +
	    "                                <option value=\"client\">Client</option>\n" +
	    "                            </select>\n" +
	    "                        </td>\n" +
	    "                    </tr>\n" +
    ...
    list += " </select>\n" +
	    ...
	    "</td>" +
	    "<td>" +
	    "<input type=\"text\" name=\"rank\" maxlength=\"45\" placeholder=\"Type rank\" class=\"txt\" required/>" +
	    "</td>" +
	    "<td>" +
	    "<p class=\"label\">" +
	    "Section:" +
	    ...
	    "</td>" +
	    "<td>" +
	    "<input type=\"text\" name=\"section\" maxlength=\"45\" placeholder=\"Type section\" class=\"txt\" required/>" +
	    "</td>" +
	    "</tr>" +
	    "                </table>\n" +
	    "                <br>\n" +
...
function validateFormAddSupervisor() {
    var username = document.forms["addAccountForm"]["username"].value;
    var password = document.forms["addAccountForm"]["password"].value;
    var type = document.forms["addAccountForm"]["type"].value;
    var firstName = document.forms["addAccountForm"]["firstName"].value;
    ...
    var email = document.forms["addAccountForm"]["email"].value;
    var status = document.forms["addAccountForm"]["status"].value;
    var rank = document.forms["addAccountForm"]["rank"].value;
    var section = document.forms["addAccountForm"]["section"].value;


    if ((username == "") || (password == "") || (type == "") || (firstName == "") || (lastName == "") || (year == "") || (month == "") || (day == "") || (telephone == "") || (email == "") || (status == "") || (rank == "") || (section == "")) {
	alert("All field must be filled out");
	return false;
    }
...
function addAccountRoot() {
    var list = "<section class=\"sectionRoot\">\n" +
	    "            <form action=\"addAccountResult.jsp\" method=\"post\" name=\"addAccountForm\" onsubmit=\"return validateFormAddRoot()\">\n" +
	    "                <table>\n" +
	    "                    <tr>\n" +
	    "                        <td>\n" +
	    "                            <p class=\"label\">\n" +
...
function validateFormAddRoot() {
    ...
    if ((username == "") || (password == "") || (type == "") || (firstName == "") || (lastName == "") || (year == "") || (month == "") || (day == "") || (telephone == "") || (email == "") || (status == "")) {
	alert("All field must be filled out");
	return false;
    }
