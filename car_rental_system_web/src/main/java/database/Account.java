...
import referance.UserReference;
...
public class Account {
	...
	String usernameSQL = null;
	String firstNameSQL = null;
	String firstName = null;
	try {
	    PreparedStatement preparedStatement = connection.prepareStatement("select account_detail.username,account_detail.firstName from car_rental_system.account_detail where username=?;");
	    preparedStatement.setString(1, username);
	    ResultSet resultSet = preparedStatement.executeQuery();
	    if (resultSet.next()) {
		usernameSQL = resultSet.getString(1);
		firstNameSQL = resultSet.getString(2);
		preparedStatement.close();
		resultSet.close();
	    }
	    if (username.equalsIgnoreCase(usernameSQL)) {
		...
		firstName = "Account is not exists";
	    }
	} catch (SQLException e) {
	...
	String usernameSQL = null;
	String lastNameSQL = null;
	String lastName = null;
	try {
	    PreparedStatement preparedStatement = connection.prepareStatement("select account_detail.username,account_detail.lastName from car_rental_system.account_detail where username=? ;");
	    preparedStatement.setString(1, username);
	    ResultSet resultSet = preparedStatement.executeQuery();
	    if (resultSet.next()) {
		usernameSQL = resultSet.getString(1);
		lastNameSQL = resultSet.getString(2);
		preparedStatement.close();
		resultSet.close();
	    }
	    if (username.equalsIgnoreCase(usernameSQL)) {
		...
		lastName = "Account is not exists";
	    }
	} catch (SQLException e) {
	...
	String email = null;
	try {
	    PreparedStatement preparedStatement = connection.prepareStatement("select account_detail.username,account_detail.email from car_rental_system.account_detail where username=? ;");
	    preparedStatement.setString(1, username);
	    ResultSet resultSet = preparedStatement.executeQuery();
	    if (resultSet.next()) {
		usernameSQL = resultSet.getString(1);
	...
	int telephone = 0 ;
	try {
	    PreparedStatement preparedStatement = connection.prepareStatement("select account_detail.username,account_detail.telephone from car_rental_system.account_detail where username=? ;");
	    preparedStatement.setString(1, username);
	    ResultSet resultSet = preparedStatement.executeQuery();
	    if (resultSet.next()) {
		usernameSQL = resultSet.getString(1);
		telephoneSQL = resultSet.getInt(2);
		preparedStatement.close();
		resultSet.close();
	    }
	    if (username.equalsIgnoreCase(usernameSQL)) {
